...
int main()
{
    ...
    while(t--)
    {
        string s;
      ll z=0, o=0; cin>> s;
      rep(i, 0, s.size()){if(s[i]=='0') z++; else o++;}
      if(z==s.size()){ rep(i, 0, s.size()) cout<< 0; cout<< endl;}
      else if(o==s.size()){ rep(i, 0, s.size()) cout<< 1; cout<< endl;}
      else {rep(i, 0, s.size()) cout<< "10"; cout<< endl;}
    }
    return 0;
}